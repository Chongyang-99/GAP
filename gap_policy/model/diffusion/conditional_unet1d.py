...
from gap_policy.model.diffusion.conv1d_components import (
    Downsample1d,
    Upsample1d,
    Conv1dBlock,
)
from gap_policy.model.diffusion.positional_embedding import SinusoidalPosEmb
    ...
    def forward(
        ...
        **kwargs,
        ...
        if not torch.is_tensor(timesteps):
            # Scalar timesteps require CPU/GPU synchronization; tensor timesteps avoid that cost.
